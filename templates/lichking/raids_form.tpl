	...
	<div class="contentBody" align="center">
		<table width="100%" cellpadding="3" cellspacing="1" border="0">
			<tr>
			  ...
			  <div align="right">{$templateText}:</div></td>
				<td width="75%" valign="top" class="field_class">
					<div align="left">
						<select name="raid_template" onchange="MM_jumpMenu('parent',this,0)">
							{$templates}
						</select>
					</div>			  </td>
			</tr>
			<tr>
              ...
              <td valign="top" class="field_class"><div align="left">
                  <input name="location" style="width:125px" type="text" class="post" id="location" value="{$location|escape}">
      {validate id="location" message="<span class=formError>$locationError</span>"} </div></td>
		  </tr>
			<tr>
              <td align="right" valign="top" class="name_class"><div align="right">{$dateText}:</div></td>
              <td valign="top" class="field_class"><div align="left">
                  <input name="date" style="width:125px" type="text" class="post" id="date" value="{$date|escape}">
                  <a href="javascript:setWeekDay({$firstDayOfWeek});showCal('Calendar1')">[+]</a>{validate id="date" message="<span class=formError>$dateError</span>"} </div></td>
		  </tr>
			<tr>
			  <td align="right" valign="top" class="name_class"><div align="right">{$inviteText}:</div></td>
			  <td valign="top" class="field_class"><select name="invite_time_hour" id="invite_time_hour">
			...
			<tr>
			  ...
			  <td valign="top" class="field_class"><select name="start_time_hour" id="start_time_hour">
			...
			<tr>
			  ...
			  <td valign="top" class="field_class"><select name="freeze_time" id="freeze_time">
			...
			<tr>
              ...
              <textarea name="description" cols="50" rows="10" id="description">{$description|escape}</textarea></td>
		  </tr>
			<tr>
			...
			<tr>
              ...
              <td valign="top" class="field_class"><div align="left">
                  <input name="minimum_level" style="width:30px" type="text" class="post" id="minimum_level" value="{$minimum_level|escape}">
      {validate id="minimum_level" message="<span class=formError>$minError</span>"} </div></td>
		  </tr>
			<tr>
              <td align="right" valign="top" class="name_class"><div align="right">{$maxText}:</div></td>
              <td valign="top" class="field_class"><div align="left">
                  <input name="maximum_level" style="width:30px" type="text" class="post" id="maximum_level" value="{$maximum_level|escape}">
      {validate id="maximum_level" message="<span class=formError>$maxError</span>"} </div></td>
		  </tr>
			<tr>
              <td align="right" valign="top" class="name_class"><div align="right">{$raidersText}:</div></td>
              <td valign="top" class="field_class"><div align="left">
                  <input name="maximum" style="width:30px" type="text" class="post" id="raiders" value="{$maximum|escape}">
      {validate id="maximum" message="<span class=formError>$maximumError</span>"} </div></td>
		  </tr>
			<tr>
